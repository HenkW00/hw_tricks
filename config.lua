...
Config.SpecificVehicle      = false      -- If set to true, you will be able to do tricks only on some specific bikes from the 'Config.Vehicles' list
...
Config.SimpleKey            = 73   -- You can find value here: https://docs.fivem.net/docs/game-references/controls/